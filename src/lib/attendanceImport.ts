...
export function attendanceListTemplateRows(): Record<string, string>[] {
  return [
    { 'رقم القيد': '2024001', التاريخ: '2024-06-01', الحالة: 'حاضر', ملاحظة: '' },
    { 'رقم القيد': '2024001', التاريخ: '2024-06-02', الحالة: 'متأخر', ملاحظة: '' },
    { 'رقم القيد': '2024002', التاريخ: '2024-06-01', الحالة: 'غائب', ملاحظة: 'بدون عذر' },
  ];
}
