...
-- لتمكين المعلم من منح نقاط لأي طالب عبر مسح QR (بدون قيد الفصل)
...
-- 2. تحديث دالة enforce_teacher_points_grant لتخطي فحص الفصل عند مصدر QR
...
BEGIN
  -- نقاط الاختبارات أو مسح QR تتخطى قيود الفصل والميزانية
